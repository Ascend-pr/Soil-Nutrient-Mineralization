...
2. Compare nutrient availability across soil texture classes

3. Evaluate the effect of soil amendments on nitrate and phosphate levels
...
- Measured Parameters
 ...
 - Experimental Structure
   ...
   - T hree replicates per treatment combination
...
- [x] Peak nitrate concentration (mg/kg)

- [x] Average nitrate concentration (mg/kg)

- [x] Average phosphate concentration (mg/kg)

- [x] Maximum incubation duration (days)
...
2. Clustered column charts comparing:
...
**💡 Key Insights**
 ...
 2. Biochar treatments improved phosphate retention, particularly in clay soils

 3. Soil texture significantly influenced nutrient availability and treatment response
...
This project demonstrates:
 ...
 - Applied Excel data analysis

 - KPI development

 - Dashboard reporting

 - Integration of agricultural and soil science domain knowledge

It is suitable for showcasing skills for:

 - Entry-level data analyst roles

 - Agronomy and environmental science positions
